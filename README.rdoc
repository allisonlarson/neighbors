...
=== Timeline
==== Week 1:
* Have a site that shows stuff.
* Have users see, rate, and save locations.
* Have user pages
* Scrape 5280/Yelp for locations and reviews.
* Have locations that are sorted by neighborhood.
* Have neighborhood pages.
* Have SMS to users.

==== Week 2:
* Have a map that is interactive.
...
{<img src="https://coveralls.io/repos/allisonlarson/neighbors/badge.png" alt="Coverage Status" />}[https://coveralls.io/r/allisonlarson/neighbors]
